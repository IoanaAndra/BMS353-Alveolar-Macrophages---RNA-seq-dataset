...
VEZI DACA ACEASTA BUCATA DE PLOT VINE DUPA PCA CU vsd
```{r tidy = FALSE, collapse = FALSE, message = FALSE, warning=FALSE}
...
```{r message = FALSE, echo = FALSE, warning=FALSE, fig.cap=" put here caption"}
plotPCA(vsd,intgroup="time") + theme_bw() + ggtitle("title")
```


```{r message = FALSE, echo = FALSE, warning=FALSE, fig.cap=" put here caption"}
plotPCA(vsd,intgroup="time") + theme_bw() + geom_label(aes(label = sampleinfo$name)) + ggtitle("title") #same as above but with labels
```
...
```{r message = FALSE, echo = FALSE, warning=FALSE, fig.cap=" put here caption"}
 plotPCA(vsd,intgroup= c("time","condition")) + theme_bw() + ggtitle("title")  
