...
sampleinfo <- read.delim("meta_data/sampleInfo.txt") #reads in delimited text files
...
quantFile_51 <- read_tsv(file = 'salmon_quant/SRR7457551/quant.sf')
...
quantFile_53 <- read_tsv(file = 'salmon_quant/SRR7457553/quant.sf')


plotVar <- ggplot(quantFile_53, aes(x = quantFile_53$TPM, y = quantFile_53$Length)) +
  geom_point()
plotVar + theme_bw()
```
