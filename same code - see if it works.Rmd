...
datasetPath <- "tx2gene.csv" #asigning value which represent part of the path, in this case, just the name of the file worked

file.exists(datasetPath) #file.exists() return TRUE id file can be found or FALSE if it is not found


dataGenes <- read_csv(datasetPath) #storing content of csv file into variable data_genes
